using CoreCarBook.Dto.StatisticDtos;
...
namespace CoreCarBook.WebUI.Areas.Admin.Controllers
{
    ...
    { 
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik15
            var responseMessage15 = await client.GetAsync("https://localhost:7193/api/Statistics/GetCarBrandAndModelByRentPriceDailyMax");
            ...
            #region İstatistik16
            var responseMessage16 = await client.GetAsync("https://localhost:7193/api/Statistics/GetCarBrandAndModelByRentPriceDailyMin");
